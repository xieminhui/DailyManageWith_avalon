...
module.exports = function(app) {
    ...
    //添加新的类别
    app.post('/addSpendType', function(req, res) {
    ...
    app.post('/addSpending', function(req, res) {
        AdminCtrl.addSpending(req, res);
    });

    //获取全部类别数据
    app.get('/seeAllSpend', function(req, res) {
        AdminCtrl.seeAllSpend(req, res);
    });

    //接受类别数据的修改
    app.put('/seeAllSpend/:id', function(req, res) {
        AdminCtrl.updateSpend(req, res);
    });

    //删除类别
    app.delete('/seeAllSpend/:id', function(req, res) {
        AdminCtrl.deleteSpend(req, res);
    });
